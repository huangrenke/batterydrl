...
class SimpleBatterySimEnv(gym.Env):
    ...
    def __init__(self, LMP_file, istartday, simulastdays, traindayset):
    ...
    def _reset(self):
        ...
        #selectdays = [3,7,12,33,43,62,69,80,91,97,98,108,116,123,126,136,144,153,161,174,192,199,225,230,234,247,261,274,281,287,295,305,313,320]
