...
storedData = "./storedData_round2_nolastpenalty"
...
def main(learning_rate):
    ...
    print("Saving final model to simple_battery_model_lr_%s_100k.pkl" % (str(learning_rate)))
    act.save(savedModel + "/" + model_name + "_lr_%s_100k.pkl" % (str(learning_rate)))
